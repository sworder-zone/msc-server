 ...
 * @property string $to 跳转进入页面
 * @property string $from 来源页面
 * @property string $subType 子类型 ：popstate、hashchange
 * @property string $duration from 页面 停留时间
 * @property string $startTime 时间
...
class PageLog extends Model
{
     ...
     */
    protected ?string $table = 'page_log';

    /**
     * The attributes that are mass assignable.
     */
    protected array $fillable = ['id', 'category', 'monitorAppId', 'userAgent', 'uuId', 'level', 'happenTime', 'deviceType', 'os', 'browserInfo', 'device', 'deviceModel', 'screenHeight', 'screenWidth', 'language', 'netWork', 'ip', 'country', 'province', 'city', 'pageUrl', 'simpleUrl', 'to', 'from', 'subType', 'duration', 'startTime', 'referrer', 'type'];
